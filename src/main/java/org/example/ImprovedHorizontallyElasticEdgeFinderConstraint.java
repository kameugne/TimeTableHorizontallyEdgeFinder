...
public class ImprovedHorizontallyElasticEdgeFinderConstraint extends AdjustmentsPropagator {
    ...
    public ImprovedHorizontallyElasticEdgeFinderConstraint(IntVar[] startingTimes_makespan, IntVar[] endingTimes, Integer[] heights, Integer[] processingTimes, int capacity) {
    ...
    public void propagate(int evtmask) throws ContradictionException {
        ...
        do
        {
            ...
            ImprovedHorizontallyElasticEdgeFinder ef = new ImprovedHorizontallyElasticEdgeFinder(tasks, capacity);
            int[] estprime = ef.Filter();
            ImprovedHorizontallyElasticEdgeFinder ef_negative = new ImprovedHorizontallyElasticEdgeFinder(negativeTasks, capacity);
