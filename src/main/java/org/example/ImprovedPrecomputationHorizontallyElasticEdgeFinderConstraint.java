...
public class ImprovedPrecomputationHorizontallyElasticEdgeFinderConstraint extends AdjustmentsPropagator {
    ...
    public ImprovedPrecomputationHorizontallyElasticEdgeFinderConstraint(IntVar[] startingTimes_makespan, IntVar[] endingTimes, Integer[] heights, Integer[] processingTimes, int capacity) {
    ...
    public void propagate(int evtmask) throws ContradictionException {
        ...
        do
        {
            ...
            ImprovedPrecomputationHorizontallyElasticEdgeFinder ef = new ImprovedPrecomputationHorizontallyElasticEdgeFinder(tasks, capacity);
            int[] estprime = ef.Filter();
            ImprovedPrecomputationHorizontallyElasticEdgeFinder ef_negative = new ImprovedPrecomputationHorizontallyElasticEdgeFinder(negativeTasks, capacity);
