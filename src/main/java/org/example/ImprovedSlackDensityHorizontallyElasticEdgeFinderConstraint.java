...
public class ImprovedSlackDensityHorizontallyElasticEdgeFinderConstraint extends AdjustmentsPropagator {
    ...
    public ImprovedSlackDensityHorizontallyElasticEdgeFinderConstraint(IntVar[] startingTimes_makespan, IntVar[] endingTimes, Integer[] heights, Integer[] processingTimes, int capacity) {
    ...
    public void propagate(int evtmask) throws ContradictionException {
        ...
        do
        {
            ...
            ImprovedSlackDensityHorizontallyElasticEdgeFinder ef = new ImprovedSlackDensityHorizontallyElasticEdgeFinder(tasks, capacity);
            int[] estprime = ef.Filter();
            ImprovedSlackDensityHorizontallyElasticEdgeFinder ef_negative = new ImprovedSlackDensityHorizontallyElasticEdgeFinder(negativeTasks, capacity);
