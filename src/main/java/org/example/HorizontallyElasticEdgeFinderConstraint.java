...
public class HorizontallyElasticEdgeFinderConstraint extends AdjustmentsPropagator {
    ...
    public HorizontallyElasticEdgeFinderConstraint(IntVar[] startingTimes_makespan, IntVar[] endingTimes, Integer[] heights, Integer[] processingTimes, int capacity) {
    ...
    public void propagate(int evtmask) throws ContradictionException {
        ...
        do
        {
            ...
            HorizontallyElasticEdgeFinder ef = new HorizontallyElasticEdgeFinder(tasks, capacity);
            int[] estprime = ef.Filter();
            HorizontallyElasticEdgeFinder ef_negative = new HorizontallyElasticEdgeFinder(negativeTasks, capacity);
