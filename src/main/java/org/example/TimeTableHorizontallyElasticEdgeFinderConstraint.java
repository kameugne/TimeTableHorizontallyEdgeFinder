...
public class TimeTableHorizontallyElasticEdgeFinderConstraint extends AdjustmentsPropagator {
    ...
    public TimeTableHorizontallyElasticEdgeFinderConstraint(IntVar[] startingTimes_makespan, IntVar[] endingTimes, Integer[] heights, Integer[] processingTimes, int capacity) {
    ...
    public void propagate(int evtmask) throws ContradictionException {
        ...
        do
        {
            ...
            TimeTableHorizontallyElasticEdgeFinder qef = new TimeTableHorizontallyElasticEdgeFinder(tasks, capacity);
            int[] estprime = qef.Filter();
            TimeTableHorizontallyElasticEdgeFinder qef_negative = new TimeTableHorizontallyElasticEdgeFinder(negativeTasks, capacity);
            int[] estprime_negative = qef_negative.Filter();
            ...
            if(qef.makespan > makespan.getLB())
                makespan.updateLowerBound(qef.makespan, this);
