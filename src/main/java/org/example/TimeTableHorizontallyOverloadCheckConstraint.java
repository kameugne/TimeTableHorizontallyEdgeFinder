...
public class TimeTableHorizontallyOverloadCheckConstraint extends AdjustmentsPropagator {
    ...
    public TimeTableHorizontallyOverloadCheckConstraint(IntVar[] startingTimes_makespan, IntVar[] endingTimes, Integer[] heights, Integer[] processingTimes, int capacity) {
    ...
    public void propagate(int evtmask) throws ContradictionException {
        ...
        do
        {
            ...
            TimeTableHorizontallyElasticEdgeFinder ef = new TimeTableHorizontallyElasticEdgeFinder(tasks, capacity);
            TimeTableHorizontallyElasticEdgeFinder ef_negative = new TimeTableHorizontallyElasticEdgeFinder(negativeTasks, capacity);
            if (!ef.OverloadCheck() || !ef_negative.OverloadCheck()) {
