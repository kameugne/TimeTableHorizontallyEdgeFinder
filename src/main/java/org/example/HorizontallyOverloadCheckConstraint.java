...
public class HorizontallyOverloadCheckConstraint extends AdjustmentsPropagator {
    ...
    public HorizontallyOverloadCheckConstraint(IntVar[] startingTimes_makespan, IntVar[] endingTimes, Integer[] heights, Integer[] processingTimes, int capacity) {
    ...
    public void propagate(int evtmask) throws ContradictionException {
        ...
        do
        {
            ...
            FTHorizontallyEdgeFinderRevisited ef = new FTHorizontallyEdgeFinderRevisited(tasks, capacity);
            FTHorizontallyEdgeFinderRevisited ef_negative = new FTHorizontallyEdgeFinderRevisited(negativeTasks, capacity);
