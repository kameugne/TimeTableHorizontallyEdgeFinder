...
public class TimeTableEdgeFinderConstraint extends AdjustmentsPropagator {
    ...
    public TimeTableEdgeFinderConstraint(IntVar[] startingTimes_makespan, IntVar[] endingTimes, Integer[] heights, Integer[] processingTimes, int capacity) {
    ...
    public void propagate(int evtmask) throws ContradictionException {
        ...
        do
        {
            ...
            TimeTableEdgeFinder qef = new TimeTableEdgeFinder(tasks, capacity);
            int[] estprime = qef.Filter();
            TimeTableEdgeFinder qef_negative = new TimeTableEdgeFinder(negativeTasks, capacity);
