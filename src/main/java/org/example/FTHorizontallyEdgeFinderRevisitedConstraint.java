 ...
 *
 **/
public class FTHorizontallyEdgeFinderRevisitedConstraint extends AdjustmentsPropagator {
    ...
    public FTHorizontallyEdgeFinderRevisitedConstraint(IntVar[] startingTimes_makespan, IntVar[] endingTimes, Integer[] heights, Integer[] processingTimes, int capacity) {
