...
public class TimeTableOverloadCheckConstraint extends AdjustmentsPropagator {
    ...
    public TimeTableOverloadCheckConstraint(IntVar[] startingTimes_makespan, IntVar[] endingTimes, Integer[] heights, Integer[] processingTimes, int capacity) {
    ...
    public void propagate(int evtmask) throws ContradictionException {
        ...
        do
        {
            ...
            TimeTableEdgeFinder ef = new TimeTableEdgeFinder(tasks, capacity);
            TimeTableEdgeFinder ef_negative = new TimeTableEdgeFinder(negativeTasks, capacity);
