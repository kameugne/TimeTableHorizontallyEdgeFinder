...
public class QuadHorizontallyElasticEdgeFinderConstraint extends AdjustmentsPropagator {
    ...
    public QuadHorizontallyElasticEdgeFinderConstraint(IntVar[] startingTimes_makespan, IntVar[] endingTimes, Integer[] heights, Integer[] processingTimes, int capacity) {
    ...
    public void propagate(int evtmask) throws ContradictionException {
        ...
        do
        {
            ...
            QuadHorizontallyElasticEdgeFinder ef = new QuadHorizontallyElasticEdgeFinder(tasks, capacity);
            int[] estprime = ef.Filter();
            QuadHorizontallyElasticEdgeFinder ef_negative = new QuadHorizontallyElasticEdgeFinder(negativeTasks, capacity);
