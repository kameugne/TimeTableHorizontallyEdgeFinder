...
public class SlackDensityHorizontallyElasticEdgeFinderConstraint extends AdjustmentsPropagator {
    ...
    public SlackDensityHorizontallyElasticEdgeFinderConstraint(IntVar[] startingTimes_makespan, IntVar[] endingTimes, Integer[] heights, Integer[] processingTimes, int capacity) {
    ...
    public void propagate(int evtmask) throws ContradictionException {
        ...
        do
        {
            ...
            SlackDensityHorizontallyElasticEdgeFinder ef = new SlackDensityHorizontallyElasticEdgeFinder(tasks, capacity);
            int[] estprime = ef.Filter();
            SlackDensityHorizontallyElasticEdgeFinder ef_negative = new SlackDensityHorizontallyElasticEdgeFinder(negativeTasks, capacity);
